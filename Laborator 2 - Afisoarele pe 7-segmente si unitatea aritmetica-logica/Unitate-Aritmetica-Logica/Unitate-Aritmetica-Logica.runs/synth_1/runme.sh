...
HD_PWD='D:/Documents/Facultate/AC/Laborator/Laborator 2 - Afisoarele pe 7-segmente si unitatea aritmetica-logica/Unitate-Aritmetica-Logica/Unitate-Aritmetica-Logica.runs/synth_1'
cd "$HD_PWD"
