...
HD_PWD='D:/Documents/Facultate/AC/Computer-Architecture-Labs/Laborator 3 - Unitatile de memorare/Bloc de Registre 32x32/Bloc de Registre 32x32.runs/synth_1'
cd "$HD_PWD"
